...
const FolderInputField = ({ handleFolderSubmit, handleFolderCheck, handleFolderCross, handleCross }) => {
    return (
        <section id='AddFolder' className=''>
            <div className='border-2 border-black rounded-sm w-fit m-2 p-2 flex items-center gap-2'>
                <form id='folderForm' className='flex items-center gap-2' onSubmit={handleFolderSubmit}>
