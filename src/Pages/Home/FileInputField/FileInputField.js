...
const FileInputField = ({ handleCross, handleFileSubmit, handleFileCheck }) => {
    return (
        <section id='AddFolder' className=''>
            <div className='border-2 border-black rounded-sm w-fit m-2 p-2 flex items-center gap-2'>
                <form id='fileForm' className='flex items-center gap-2' onSubmit={handleFileSubmit}>
                    <input name='rootFolderName' onChange={handleFileCheck} id='input' type="text" className='border-2 border-orange-400 p-2 rounded-sm w-60 text-lg' required />
